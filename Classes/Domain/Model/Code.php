...
namespace F3\Converter\Domain\Model;
...
class Code {
	...
	/**
	 * @param \F3\Converter\Domain\Model\User $user
	 * @return void
	 */
	public function setUser(\F3\Converter\Domain\Model\User $user) {
		$this->user = $user;
	}

	/**
	 * @return F3\Converter\Domain\Model\User
	 */
	...
	/**
	 * @param \F3\Converter\Domain\Model\Codetype $codetype
	 * @return void
	 */
	public function setCodetype(\F3\Converter\Domain\Model\Codetype $codetype) {
		$this->codetype = $codetype;
	}

	/**
	 * @return \F3\Converter\Domain\Model\Codetype
	 */
